...
This app illustrates how to use Blockly together with common programming tools like node/npm, Vite, typescript, eslint, and others. You can use it as the starting point for your own application and modify it as much as you'd like. It contains basic infrastructure for running, building, testing, etc. that you can use even if you don't understand how to configure the related tool yet. When your needs outgrow the functionality provided here, you can replace the provided configuration or tool with your own.
...
- Building/bundling: Vite to build the source code for production.
- Development server: Vite dev server to run locally while in development.
...
- `index.html` is the app entry HTML used by Vite during development and build.
...
- `index.html` contains the skeleton HTML for the page and loads the app entry module.
